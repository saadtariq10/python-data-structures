...
if __name__ == "__main__":
    orders = ["Burger", "Pizza", "Pasta", "Sushi", "Noodles"]
...
# 4th and 5th number are second number (i.e. 10) + 0 and 
# second number (i.e. 10) + 1.

# You also need to add front() function in queue class that can return the front 
